...
public class RetrofitProvider {
    ...
    private RetrofitProvider(){
        OkHttpClient okHttpClient = OkHttpProvider.INSTANCE.createOkHttpClient();
       ...
       this.haplioService=this.retrofit.create(HapiloService.class);
        this.appContext= BaseApplication.Companion.getInstance();
    }
    ...
    public Observable<HttpResult<DeviceMSG>> getDeviceMsg(Map<String,Object> params){
      ...
      public Subscription  getActivityDreeList(Map<String,Object> params,ResponseResultListener<ActivityDereeListBean> responseResultListener){
